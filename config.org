...
Reasonable default templates are provided for the packages, however, if you wish to change these refer to the respective packages for in depth instructions.
...
taken from [[https://gist.github.com/politza/3f46785742e6e12ba0d1a849f853d0b9#file-scroll-other-window-el][scroll-other-window.el · GitHub]]

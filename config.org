...
I cannot recall what the purpose of this is
# rename the feeds
# #+BEGIN_SRC emacs-lisp
# (defadvice elfeed-search-update (before nullprogram activate)
#   (let ((feed (elfeed-db-get-feed "http://export.arxiv.org/api/query?search_query=cat:math.OC&start=0&max_results=3000&sortBy=submittedDate&sortOrder=descending")))

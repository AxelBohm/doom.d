...
Use ripgrep in a normal grep buffer. The live ~counsel-rg~ minibuffer UI is nice
when it works, but it has repeatedly triggered native macOS Emacs hangs in this
setup.
